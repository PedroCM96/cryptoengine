...
export class NonPlayableCharacter extends Character {
    ...
    constructor(
        ...
        super(img, position, canMove, lookingAt, false, CHARACTER_ANIMATION_MAP, CHARACTER_ANIMATION_SPEED);
    ...
    private getRenderPosition(tlp: Position): Position {
        ...
        const deltaX = Math.round(targetPositionRenderPosition.x - this.currentRenderPosition.x);
        const deltaY = Math.round(targetPositionRenderPosition.y - this.currentRenderPosition.y);
